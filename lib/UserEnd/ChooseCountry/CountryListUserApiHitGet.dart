...
class UserChooseCountry extends StatefulWidget {
  @override
  _UserChooseCountry createState() => _UserChooseCountry();
}

class _UserChooseCountry extends State<UserChooseCountry> {
  ...
  Future getData() async {
    ...
    http.Response response =  await http.get(APPURLS_USER.GET_USER_COUNTRY_LIST_URL, headers: {
      'x-api-key': 'boguskey',
    });
    ...
    setState(() {
      userData = data["data"];
      String code = userData[0]["phone_code"].toString();
      print("===country data==="+code.toString());
    });
  ...
  _onSelected(int index) {
    ...
    setState(() {
      ...
      myPrefs.setString(STORE_PREFS.USER_COUNTRY_CODE,userData[index]["phone_code"].toString());
    });
  }
  @override
  void initState() {
