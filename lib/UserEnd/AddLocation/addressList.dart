...
class _Address extends State<AddressList> {
    int delete_index;
  ...
  _onSelected(int index) {
    ...
    setState(() {
      ...
      myPrefs.setString(STORE_PREFS.USER_BOOKING_ADDRESS,userData[index]['address'].toString());
      myPrefs.setString(STORE_PREFS.USER_BOOKING_FLAT,userData[index]['flat'].toString());
      myPrefs.setString(STORE_PREFS.USER_BOOKING_ADDRESS_NAME,userData[index]['name'].toString());
      myPrefs.setString(STORE_PREFS.USER_BOOKING_PHONE,userData[index]['phone'].toString());
      myPrefs.setString(STORE_PREFS.USER_BOOKING_INSTRUCTION_CODE,userData[index]['code'].toString());
      myPrefs.setString(STORE_PREFS.USER_BOOKING_KEYFILE_NAME,userData[index]['keyfile'].toString());
      myPrefs.setString(STORE_PREFS.USER_BOOKING_SAVED_ADDRESS_TYPE,userData[index]['type'].toString());
      myPrefs.setString(STORE_PREFS.USER_BOOKING_LAT,userData[index]['lat'].toString());
      myPrefs.setString(STORE_PREFS.USER_BOOKING_LOG,userData[index]['log'].toString());
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                            ...
                            Container(
                              ...
                              color: _selectedIndex != null && _selectedIndex == index ? Color.fromRGBO(220,220,220,100)
                              : Colors.transparent,
                        child: Column(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
