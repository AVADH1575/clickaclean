...
class UserNotificationHistory extends StatefulWidget {
  @override

  State<StatefulWidget> createState() {
// TODO: implement createState
    return _UserNotificationHistory();
  }
}

class _UserNotificationHistory extends State<UserNotificationHistory> {
  ...
  Future getNotificationData() async {
    ...
    http.Response response =  await http.get(APPURLS_USER.GET_USER_NOTIFICATION_LIST_API, headers: {
