...
class IdentityAllowCameraAccess extends StatefulWidget {

  String type;

  IdentityAllowCameraAccess({this.type,});

  @override
  State<StatefulWidget> createState() {
    return _IdentityAllowCameraAccess();
  }
}
class _IdentityAllowCameraAccess extends State<IdentityAllowCameraAccess> {
                        ...
                        children: <Widget>[
                          ...
                          Align(
                            ...
                            child: Padding(
                                ...
                                child:
                                Text("Enable your camera to take pictures with your mobile",
                          ...
                          Padding(
                              ...
                              child:
                              Text("If you deny camera access you won't be able to take pictures and complete the verification process",
                        ...
                        child: RaisedButton(
                          ...
                          child: Container(
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Text('ENABLE CAMERA',style: TextStyle(
                                  fontSize: 16,
                                  color: Colors.white,)),
...
//                            )],)
  ...
  Future getCameraImage(String type) async {
    ...
    setState(() {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => IdentityAllowCameraAccessSecond(imagePath:image.path,type: type,)),
      );
    });
  }
