...
class TermsAndConditionsProfile extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _TermsAndConditionsProfile();
  }
}
class _TermsAndConditionsProfile extends State<TermsAndConditionsProfile> {
