...
import 'IdentityCameraBackIDUpload.dart';
...
class IdentityAllowCameraAccessSecond extends StatefulWidget {
  ...
  IdentityAllowCameraAccessSecond({this.imagePath,this.type,this.check_back});
  @override
...
class _IdentityAllowCameraAccessSecond extends State<IdentityAllowCameraAccessSecond> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: Text(widget.type), backgroundColor: Color.fromRGBO(241, 123, 72, 1),),
...
alignment: Alignment.center,
                child:Column(
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      children: <Widget>[
                        ButtonChangeString_forBack == null
                            ?
                            Container(
                                height: 60,
...
//                            )],)
                                  ...
                                  onPressed: () {
                                    ...
                                    setState(() {
                                      ButtonChangeString_forBack = "BACK";
                                    });
                                  }, )):
...
Form(key: _formKey,
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                    Text("TAKE BACK PICTURE",style: TextStyle(
                    fontSize: 16,
                    color: Colors.white,)),
...
//                            )],)
  ...
  Uri apiUrl = Uri.parse(
      'http://35.178.249.246/app/api/user/NationalIdFront');
  ...
  void _resetState() {
    setState(() {
      ...
      Fluttertoast.showToast(
          msg: "Document Uploaded! Please take back picture",
  ...
  Future getCameraImage() async {
    ...
    setState(() {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => IdentityAllowCameraAccessSecond(imagePath:image.path,type: widget.type,)),
      );
    });
  }
  Future getBackCameraImage() async {
    var image = await ImagePicker.pickImage(source: ImageSource.camera);
