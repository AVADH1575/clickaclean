...
class ProviderSetPassword extends StatefulWidget {
  @override
...
class _SetPassword extends State<ProviderSetPassword> {
  ...
  Future POST_RESET_API(String password,String Confirm_password) async {
    ...
    try {
      var response = await client.post(
          APPURLS_PROVIDER.POST_PROVIDER_PHONE_RESET_URL,
          headers: {"x-api-key":   myPrefs.getString(STORE_PREFS_PROVIDER.PROVIDER_API_KEY)
          },

          body: {
            'provider_password': password,
            'provider_confirmPassword': Confirm_password,
          }
      );
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            icon: Icon(Icons.arrow_back_ios, color: Color.fromRGBO(241, 123, 72, 1)),    ),
