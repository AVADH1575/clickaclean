...
class ProviderEnterPassword extends StatefulWidget {
  @override
...
class _EnterPassword extends State<ProviderEnterPassword> {
  ...
  Future POST_LOGIN_API(String password) async {
    ...
    APPURLS_PROVIDER.POST_PROVIDER_PHONE_LOGIN_URL,
          ...
          body: {
            'phone': myPrefs.getString(STORE_PREFS_PROVIDER.PROVIDER_PHONE_NUMBER_GLOBAL),
            'password': password,
