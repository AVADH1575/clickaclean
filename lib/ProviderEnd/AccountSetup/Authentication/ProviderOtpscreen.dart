...
class ProviderOTPScreen extends StatefulWidget {
  @override
  _ProviderOTPScreen createState() => new _ProviderOTPScreen();
}

class _ProviderOTPScreen extends State<ProviderOTPScreen> with SingleTickerProviderStateMixin {
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text("Setup your identity in 3 simple steps", style: TextStyle(
                  ...
                  Padding(
                      ...
                      child: SvgPicture.asset("assets/images/main-logo.svg",height: 80,width: 80,)
                  )
                ],
              ), flex: 60,),
