...
import 'ProviderBookingDetail.dart';


class OngoingLeadsScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _OngoingLeadsScreen();
  }
}
class _OngoingLeadsScreen extends State<OngoingLeadsScreen> {
  ...
  _onSelected1(int index) {
    ...
    setState(() {
      _selectedIndex = index;
      myPrefs.setString(STORE_PREFS_PROVIDER.PROVIDER_ONGOING_BOOKING_DETAIL,Time_data_list[index]['id'].toString());
      Navigator.of(
  ...
  Future getNotificationData() async {
    ...
    http.Response response =  await http.get(APPURLS_PROVIDER.GET_ONGOING_LEADS_HISTORY_URL+myPrefs.getString(STORE_PREFS_PROVIDER.PROVIDER_SERVICE_TYPE).toString(), headers: {
                                                    ...
                                                    Row(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          Container(
                                                            ...
                                                            child:FlatButton(
                                                              color: Color.fromRGBO(241, 123, 72, 1),
                                                              child:Text("Track service",style: TextStyle(
                                                                fontSize: 14, color:
                                                              Colors.white,
                                                              ),),
  ...
  void _navigateToNextScreen(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ProviderBookingDetail()),
    );
  }
